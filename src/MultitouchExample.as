package
{
	...
	public class MultitouchExample extends Sprite
	{
		...
		private static const LABEL_SPACEING:uint = 15;
		...
		private function onTouchBegin(e:TouchEvent):void
		{
			...
			var dot:Sprite = this.getCircile();
			dot.x = e.stageX;
			dot.y = e.stageY;
			...
			label.x = 3;
			label.y = this.dotCount * LABEL_SPACEING;
		...
		private function getCircile(circumference:uint = 40):Sprite
		{
